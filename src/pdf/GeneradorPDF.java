...
public class GeneradorPDF {
    ...
    try {
        ...
        tabla.addCell("Nombre"); // Agrega una celda con el encabezado "Usuario".
         tabla.addCell("Email");
        tabla.addCell("Telefono"); // Agrega una celda con el encabezado "Nombre".
        tabla.addCell("Username"); // Agrega una celda con el encabezado "Apellido".
        tabla.addCell("Tipo Nivel"); // Agrega una celda con el encabezado "Telefono".
        tabla.addCell("Estatus"); // Agrega una celda con el encabezado "Email".
        tabla.addCell("Registrado por");
        
        try {
            Connection con = Conexion.conectar(); // Establece una conexión con la base de datos.
            PreparedStatement pst = con.prepareStatement("SELECT id_usuario, nombre_usuario, email, telefono, username, tipo_nivel, estatus, registrado_por FROM tb_usuarios"); 
